ace.define("ace/mode/spec_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";
...
var SpecHighlightRules = function(options) {
    ...
    var mainKeywordsByType = {
        "markup.heading.2":
            "rule|invariant|methods|pragma",
        "keyword.control":
            "invoke|sinvoke|require|static_assert|assert|static_require|method|calldataarg|envfree|env|msg|lastReverted|currentContract|if|else",
        "storage.type":
            "bool|address|" + intTypes,
        "storage.type.array.dynamic":
            "bytes|string",
        "support.function":
            "addmod|blockhash|gasleft|keccak256|" +
            "revert|sha256",
...
ace.define("ace/mode/spec",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/spec_highlight_rules","ace/mode/matching_brace_outdent","ace/range","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var SpecHighlightRules = require("./spec_highlight_rules").SpecHighlightRules;
...
var Mode = function() {
    this.HighlightRules = SpecHighlightRules;
...
(function() {
    ...
    this.$id = "ace/mode/spec";
}).call(Mode.prototype);

exports.Mode = Mode;
});
                (function() {
                    ace.require(["ace/mode/spec"], function(m) {
